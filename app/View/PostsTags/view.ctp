...
<h2><?php  echo __('Posts Tag'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($postsTag['Post']['name'], array('controller' => 'posts', 'action' => 'view', $postsTag['Post']['id'])); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Posts Tag'), array('action' => 'delete', $postsTag['PostsTag']['id']), null, __('Are you sure you want to delete # %s?', $postsTag['PostsTag']['id'])); ?> </li>
